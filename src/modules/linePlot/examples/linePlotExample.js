// @fileoverview linePlotExample.js -- demos linePlot.js

import {sleep}                from '../../util/util.js';
import {rnd}                  from '../../math/math.js';
import {createDiv, getRgbStr} from '../../html/html.js';
import {LinePlot}    from '../../linePlot/linePlot.js';
...
function createTitle(parent) {
  ...
  createDiv(middle, 'title', 'linePlot.js Example');
  createDiv(middle, 'version', 'version ' + LinePlot.getVersion());
...
async function createPlot02(parent) {
  ...
  let plot = new LinePlot({parent: container, className: 'plot02'});
...
async function createPlot05(parent) {
  ...
  let plot = new LinePlot({parent: container, className: 'plot05'});
